<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/novelnest/public/config/DB.php";
        ...
        <div class="col-md-3 audiobook-item">
            <div class="audiobook-card">
                <figure class="audiobook-style">
                    <img src="/novelnest/public/assets/images/<?= !empty($audiobook['cover_image']) ? htmlspecialchars($audiobook['cover_image']) : 'default-audiobook.jpg' ?>"
                        alt="Audiobook Cover"
                        class="audiobook-item"
                        style="width: 200px; height: 250px; object-fit: cover; border-radius: 10px;">
                </figure>
                <figcaption>
                    <a href="/novelnest/public/view/pages/audiobookPage.php?id=<?= $audiobook['id'] ?>">
