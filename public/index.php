<?php $baseUrl = '/novelnest/public';

require_once $_SERVER['DOCUMENT_ROOT'] . '/novelnest/public/controller/CheckoutController.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/novelnest/public/controller/SuccessController.php';
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    fetch('/novelnest/public/controller/bookController.php?harry_potter=true')
      .then(response => response.json())
      .then(data => {
        if (data.status === 'success') {
          const booksContainer = document.getElementById('harry-potter-books');
          const baseUrl = '/novelnest/public'; // Define your base URL here
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    fetch('/novelnest/public/controller/bookController.php?all_books=true')
      .then(response => response.json())
      .then(data => {
        if (data.status === 'success') {
