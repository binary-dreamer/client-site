...
require_once $_SERVER['DOCUMENT_ROOT'] . '/novelnest/public/vendor/autoload.php'; // Ensure Stripe is loaded

// Load Stripe API keys properly
$stripe_keys = require $_SERVER['DOCUMENT_ROOT'] . '/novelnest/public/config/stripeApi.php';
    ...
    public function createSession()
    {
        ...
        try {
            $checkout_session = \Stripe\Checkout\Session::create([
                ...
                'mode' => 'subscription',
                'success_url' => 'http://localhost/novelnest/public/index.php?controller=Success&action=index&session_id={CHECKOUT_SESSION_ID}',
                'cancel_url' => 'http://localhost/novelnest/public/view/pages/subscription.php',
            ]);
