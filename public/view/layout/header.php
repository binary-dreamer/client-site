...
<head>
  ...
  <meta name="keywords" content="books, e-books, audiobooks, online reading, digital library, book subscription, fiction, horror, fantasy, historical novels, book lovers, best novels">
  <meta name="author" content="NovelNest">
  <title>NovelNest: Online Reading Platform</title>

  <!-- Canonical URL -->
  <link rel="canonical" href="https://www.novelnest.com">

  <!-- Open Graph Meta Tags (for Social Sharing) -->
  <meta property="og:title" content="NovelNest - Your Ultimate Reading Destination">
  <meta property="og:description" content="Explore a world of books with NovelNest. Read online, download e-books, listen to audiobooks, and unlock unlimited reading with our subscription plans.">
  <meta property="og:image" content="<?= $baseUrl ?>/assets/images/banner_2.jpg">
  <meta property="og:url" content="https://www.novelnest.com">
  <meta property="og:type" content="website">

  <!-- Twitter Card Meta Tags -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="NovelNest - Your Ultimate Reading Destination">
  <meta name="twitter:description" content="Read online, download e-books, and listen to audiobooks with NovelNest. Enjoy unlimited access to your favorite books.">
  <meta name="twitter:image" content="<?= $baseUrl ?>/assets/images/banner_2.jpg">
  ...
  <script type="application/ld+json">
    {
      ...
      "@type": "WebSite",
      "name": "NovelNest",
      "url": "https://www.novelnest.com",
      "description": "Explore a vast collection of books with NovelNest. Read online, download e-books, listen to audiobooks, and dive into genres like fiction, horror, fantasy, and historical novels. Enjoy unlimited reading with flexible subscription plans.",
      "potentialAction": {
        "@type": "SearchAction",
        "target": "https://www.novelnest.com/search?q={search_term_string}",
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
          ...
          <div class="offcanvas-body">
            <ul id="navbar" class="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
              <li class="nav-item">
                <a class="nav-link me-4 " href="<?= $baseUrl ?>/index.php">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link me-4" href="<?= $baseUrl ?>/view/pages/books.php">Books</a>
              </li>
              <li class="nav-item">
                  ...
                  <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                        ...
                        <li><a class="dropdown-item text-danger" href="/novelnest/public/logout.php"><i class="bi bi-box-arrow-right"></i> Logout</a></li>
                      </ul>
                    </div>
