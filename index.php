    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 pb-3 pb-lg-0">
        <div class="icon-box d-flex">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M249.6 471.5c10.8 3.8 22.4-4.1 22.4-15.5l0-377.4c0-4.2-1.6-8.4-5-11C247.4 52 202.4 32 144 32C93.5 32 46.3 45.3 18.1 56.1C6.8 60.5 0 71.7 0 83.8L0 454.1c0 11.9 12.8 20.2 24.1 16.5C55.6 460.1 105.5 448 144 448c33.9 0 79 14 105.6 23.5zm76.8 0C353 462 398.1 448 432 448c38.5 0 88.4 12.1 119.9 22.6c11.3 3.8 24.1-4.6 24.1-16.5l0-370.3c0-12.1-6.8-23.3-18.1-27.6C529.7 45.3 482.5 32 432 32c-58.4 0-103.4 20-123 35.6c-3.3 2.6-5 6.8-5 11L304 456c0 11.4 11.7 19.3 22.4 15.5z"/></svg>
          </div>
        ...
        <div class="card text-center mb-4 border-0 rounded-3 category-box">
          <a href="index.html">
            ...
            <h6 class="position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3">
              <a href="index.html" class="text-white">Fiction</a>
            </h6>
          </a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card text-center mb-4 border-0 rounded-3 category-box">
          <a href="index.html">
            ...
            <h6 class="position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3">
              <a href="index.html" class="text-white">Horror</a>
            </h6>
          </a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card text-center mb-4 border-0 rounded-3 category-box">
          <a href="index.html">
            ...
            <h6 class="position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3">
              <a href="index.html" class="text-white">Historical</a>
            </h6>
          </a>
        </div>
      </div>
          ...
          <div class="col-md-4">
            <div class="card text-center mb-4 border-0 rounded-3 category-box">
              <a href="index.html">
                ...
                <h6 class="position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3">
                  <a href="index.html" class="text-white">Science Fiction</a>
                </h6>
              </a>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card text-center mb-4 border-0 rounded-3 category-box">
              <a href="index.html">
                ...
                <h6 class="position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3">
                  <a href="index.html" class="text-white">Thriller</a>
                </h6>
              </a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card text-center mb-4 border-0 rounded-3 category-box">
              <a href="index.html">
                ...
                <h6 class="position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3">
                  <a href="index.html" class="text-white">Young Adult</a>
                </h6>
              </a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card text-center mb-4 border-0 rounded-3 category-box">
              <a href="index.html">
                ...
                <h6 class="position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3">
                  <a href="index.html" class="text-white">Education</a>
                </h6>
              </a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card text-center mb-4 border-0 rounded-3 category-box">
              <a href="index.html">
                ...
                <h6 class="position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3">
                  <a href="index.html" class="text-white">Autobiography</a>
                </h6>
              </a>
            </div>
          </div>
...
<section id="best-selling-items" class="position-relative padding-large ">
  <div class="container">
    <div class="section-title2 d-md-flex justify-content-between align-items-center mb-4">
      <h3 class="d-flex align-items-center">Books</h3>
      <a href="view/pages/books.php" class="btn">View All</a>
    </div>
    <div class="position-absolute top-50 end-0 pe-0 pe-xxl-5 me-0 me-xxl-5  product-slider-button-next">
...
<!--HTMLFlip Books section-->
<section id="best-selling-items" class="position-relative padding-large">
  <div class="container" style="margin-top: -150px;">
    <div class="section-title d-md-flex justify-content-between align-items-center mb-4">
      <h3 class="d-flex align-items-center">HTMLFlip Books</h3>
      <a href="view/pages/books.php" class="btn">View All</a>
    </div>
    <div class="position-absolute top-50 end-0 pe-0 pe-xxl-5 me-0 me-xxl-5  product-slider-button-next">
      <svg class="chevron-forward-circle d-flex justify-content-center align-items-center p-2" width="80" height="80">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100 shadow-sm border-0 rounded-3">
          <div class="card-body p-5">
            <div class="mb-4">
              <h3 class="h4 mb-2">Basic</h3>
              <p class="text-teal mb-4">Perfect for casual readers</p>
            ...
            <button class="btn btn-outline-primary w-100">Start Basic Plan</button>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100 shadow-sm border-0 rounded-3">
          <div class="card-body p-5">
            <div class="mb-4">
              <h3 class="h4 mb-2">Pro</h3>
              <p class="text-teal mb-4">Most popular choice</p>
              <div class="d-flex align-items-baseline mb-3">
                <span class="h2 mb-0 fw-bold">150rs</span>
                <span>/month</span>
              </div>
            </div>
            <ul class="list-unstyled mb-4">
            ...
            <button class="btn btn-outline-primary w-100">Start Pro Plan</button>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100 shadow-sm border-0 rounded-3">
          <div class="card-body p-5">
            <div class="mb-4">
              <h3 class="h4 mb-2">Premium</h3>
              <p class="text-teal mb-4">For the ultimate bookworm</p>
              <div class="d-flex align-items-baseline mb-3">
                <span class="h2 mb-0 fw-bold">250rs</span>
                <span>/month</span>
              </div>
            </div>
            <ul class="list-unstyled mb-4">
            ...
            <button class="btn btn-outline-primary w-100">Start Premium Plan</button>
          </div>
        </div>
      </div>
    </div>
