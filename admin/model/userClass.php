...
require_once $_SERVER['DOCUMENT_ROOT'] . '/novelnest/public/vendor/autoload.php'; // Load Stripe PHP SDK
...
class UserClass
{
    ...
    public function createUser($data)
    {
        ...
        $query = "INSERT INTO user (name, email, contact, gender, password, profile)
                  VALUES ('$name', '$email', '$contact', '$gender', '$password', '$profilePath')";
    ...
    {
        $query = "SELECT * FROM subscriptions WHERE email = ? AND subscription_status = 'Active' ORDER BY end_date DESC LIMIT 1";
        $stmt = $this->db->prepare($query);
    ...
    public function updateUser($data)
    {
        ...
        $updateFields = "name='$name', email='$email', contact='$contact', gender='$gender'";
    ...
    {
        $uploadDir = '/novelnest/admin/assets/images/'; // Ensure path is inside NovelNest
