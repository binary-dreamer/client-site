...
class MailHelper {
    public function sendMail($to, $subject, $message) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'investclaritycontact@gmail.com'; // Your email address (Gmail)
            $mail->Password = 'tnrqxdpccxtosvvk'; // Use the app password here
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port = 587;

            // Set the sender and recipient
            $mail->setFrom('investclaritycontact@gmail.com', 'NovelNest'); // Sender email
