...
if ($result->num_rows > 0) {
    ...
    <div class="custom-card position-relative p-3 border rounded-3 w-100">
                ...
                <h6 class="mt-4 mb-0 fw-bold"><a href="' . $baseUrl . '/view/pages/bookPage.php">' . htmlspecialchars($row['title']) . '</a></h6>
